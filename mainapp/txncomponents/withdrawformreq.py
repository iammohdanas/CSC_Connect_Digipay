...
from mainapp.components import bank_list, bank_iin_list
                ...
                "Creds": {
                    "Cred": {
                        ...
                        "Auth": {
                            ...
                            "Meta": {
                                "udc": "NPC000010700183",
                                "rdsId": configinput["rdsId"],
                                "rdsVer": configinput["rdsVer"],
                                "dpId": configinput["dpId"],
                                "dc": configinput["dc"],
                                "mi": configinput["mi"],
                                "mc": configinput["mc"]
                            },
                            "Skey": {
                                "@ci": configinput["ci_value"],
                                "#text": configinput["Skey_Value"]
                            },
                            "Hmac": configinput["Hmac_Value"],
                            "Data": {"@type":"X",
                                     "#text": configinput["dataValue"]} 
                        }
                    }
                },
                "Amount": {
